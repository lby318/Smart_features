...
public class SpecialCharSequenceMgr {
    ...
    public static class HandleAdnEntryAccountSelectedCallback extends SelectPhoneAccountListener{
        ...
        public void onPhoneAccountSelected(PhoneAccountHandle selectedAccountHandle,
            ...
            int subId = TelephonyManager.getDefault().getSubIdForPhoneAccount(
                    mTelecomManager.getPhoneAccount(selectedAccountHandle));
            ...
            try {
                ...
                if (subscriptionAccountHandles.size() == 1 || hasUserSelectedDefault) {
                    ...
                    PhoneAccountHandle accountHandle = hasUserSelectedDefault ?
                            telecomManager.getDefaultOutgoingPhoneAccount(PhoneAccount.SCHEME_TEL)
                            : subscriptionAccountHandles.get(0);
                    int subId = TelephonyManager.getDefault().getSubIdForPhoneAccount(
            ...
            try {
                ...
                if ((c != null) && (text != null)) {
                    ...
                    if (name != null) {
                        ...
                        name = context
                                .getString(R.string.menu_callNumber, name);
    ...
    private static boolean handleVersionCode(Context context, String input) {
        ...
        if (input.equals(PRL_VERSION_DISPLAY)) {
            ...
            try {
                int[] activeSubList = SubscriptionManager.from(
                        context).getActiveSubscriptionIdList();
                int length = activeSubList.length;
                ...
                for (int i = 0; i < length; i++) {
                    int activeSubId = activeSubList[i];
