...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: usb preference change
        mExt = UtilsExt.getDevExtPlugin(getActivity());
    }
    ...
    public void onResume() {
        ...
        boolean isChecked = (mEnableDialog != null && mEnableDialog.isShowing()) ? true
                : mLastEnabledState;
        ...
        /*if (mHaveDebugSettings && !mLastEnabledState) {
            ...
            setPrefsEnabledState(mLastEnabledState);
        }*///@darren modify for disable developer option
        mSwitchBar.show();
        /// M: usb preference change
    ...
    private void confirmEnableOemUnlock() {
        DialogInterface.OnClickListener onConfirmListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                /// M: Reset the toggle when cancel chosed. ALPS01986451.
