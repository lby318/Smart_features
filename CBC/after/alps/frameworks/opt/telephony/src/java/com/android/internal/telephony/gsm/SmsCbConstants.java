...
public class SmsCbConstants {
    ...
    /**@darren modify for cbc:禁止收到4307-4382、4410、6400、4145和4214这几个频道的信息.*/
    public static final int MESSAGE_ID_CBDD_4212_IDENTIFIER = 0x1074; //add by mtk for 4212
    public static final int MESSAGE_ID_CBDD_4214_IDENTIFIER = 0x1076; //add by mtk for 4214
    public static final int MESSAGE_ID_CBDD_4145_IDENTIFIER = 0x1031; //add by mtk for 4145
    public static final int MESSAGE_ID_CBDD_4154_IDENTIFIER = 0x103A; //add by mtk for 4154
    public static final int MESSAGE_ID_CBDD_6400_IDENTIFIER = 0x1900; //add by mtk for 6400
    public static final int MESSAGE_ID_CBDD_4411_IDENTIFIER = 0x113B;
    //@darren add end
