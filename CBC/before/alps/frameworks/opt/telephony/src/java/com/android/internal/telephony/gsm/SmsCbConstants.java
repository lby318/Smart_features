...
public class SmsCbConstants {
    ...
    // MTK - START
    /** Taiwan PWS Emergency Message in Chinese */
    public static final int MESSAGE_ID_TWN_PWS_ALERT_MSG_IN_CHINESE                 = 0x038F;

    /** Taiwan PWS Emergency Message in English */
    public static final int MESSAGE_ID_TWN_PWS_ALERT_MSG_IN_ENGLISH                 = 0x0397;
    // MTK - END
