...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
    ...
    /// M: Account is in smart push mode
    public static final int FLAGS_SMART_PUSH = 1<<14;
	...
	mSignature = "Enviado desde mi Bmobile AX675C"; //@darren add for preload email signature.
    }
    ...
    public Uri save(Context context) {
        ...
        ///M: Save the account policy for account security update.@{
        if (mPolicy != null) {
            policyIndex = index++;
