...
# CTS Video
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/media_codecs_performance.xml:system/etc/media_codecs_performance.xml
...
# PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/zechin/zechin6753_35g_m0/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/thermal_6753_eng.conf:system/etc/.tp/thermal.conf
else
    PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/thermal_6753.conf:system/etc/.tp/thermal.conf
endif

PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/thermal.wfd.6753.conf:system/etc/.tp/.thermal_policy_00
...
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/zechin6753_35g_m0/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/zechin6753_35g_m0/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/zechin/zechin6753_35g_m0/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/zechin6753_35g_m0/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/zechin6753_35g_m0/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/zechin6753_35g_m0/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
...
DEVICE_PACKAGE_OVERLAYS += device/zechin/zechin6753_35g_m0/overlay
